...
namespace IIS.Postmat11
{
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postmat11.Оплата fОплата;
        
        private double fСумма;
        
        private IIS.Postmat11.Пользователь fПользователь;
        ...
        public virtual IIS.Postmat11.Оплата Оплата
        {
            get
            {
                ...
                IIS.Postmat11.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "Пользователь"})]
        [NotNull()]
        public virtual IIS.Postmat11.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.Postmat11.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТранзакцияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияE", typeof(IIS.Postmat11.Транзакция));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТранзакцияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияL", typeof(IIS.Postmat11.Транзакция));
                }
            }
        }
    }
