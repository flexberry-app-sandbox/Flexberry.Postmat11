...
namespace IIS.Postmat11
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postmat11.Статусы fСтатус;
        
        private IIS.Postmat11.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Postmat11.DetailArrayOfЯчейка fЯчейка;
        ...
        public virtual IIS.Postmat11.Статусы Статус
        {
            get
            {
                ...
                IIS.Postmat11.Статусы result = this.fСтатус;
        ...
        public virtual IIS.Postmat11.DetailArrayOfЯчейка Ячейка
        {
            get
            {
                ...
                {
                    this.fЯчейка = new IIS.Postmat11.DetailArrayOfЯчейка(this);
                }
                IIS.Postmat11.DetailArrayOfЯчейка result = this.fЯчейка;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Postmat11.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Postmat11.Постамат));
                }
            }
        }
    }
